...
class DeliveryController extends Controller
{
    ...
    public function table_delivery_back(Request $request)
    {
        try {
    ...
    public function get_delivery_detail_back(Request $request)
    {
        try {
    ...
    public function update_delivery_back(Request $request)
    {
        try {
