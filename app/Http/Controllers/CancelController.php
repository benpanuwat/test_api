...
class CancelController extends Controller
{
    ...
    public function table_cancel_back(Request $request)
    {
        try {
    ...
    public function get_cancel_detail_back(Request $request)
    {
        try {
    ...
    public function update_cancel_back(Request $request)
    {
        try {
